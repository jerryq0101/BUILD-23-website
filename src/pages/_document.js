  ...
  return (
    <Html>
      <Head>
        ...
        <meta name="twitter:title" content="BUILD'23 - Global Hackathon" />
        <meta
          name="twitter:description"
          content="BUILD, hosted by Refoundation, is a hackathon that engages the young minds from the world to solve the most pressing issues of today's society."
        />
